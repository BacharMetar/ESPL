...
int main(int argc, char **argv)
{
    ...
    const int file_descriptor = open(file_name, O_RDWR);
    ...
    void *map_start = mmap(NULL, file_descriptor_stat.st_size, PROT_READ | PROT_WRITE, MAP_SHARED , file_descriptor, 0);
    ...
    ELF_HEADER* elf_head = (ELF_HEADER*) map_start;
